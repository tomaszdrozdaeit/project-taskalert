...
- **PWA (Offline & Mobile Support)**: Service Worker z wersjonowanym systemem pamięci podręcznej — `taskalert-v28`, wykrywaniem platformy (Android/iOS) oraz dedykowanym banerem instalacyjnym.
...
├── service-worker.js          # Pamięć podręczna (cache v28) + obsługa PUSH w tle i akcji drzemki
