...
- **PWA (Offline & Mobile Support)**: Service Worker z wersjonowanym systemem pamięci podręcznej — `taskalert-v10`, wykrywaniem platformy (Android/iOS) oraz dedykowanym banerem instalacyjnym.
