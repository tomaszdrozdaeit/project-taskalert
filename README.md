...
- **PWA (Offline Support)**: Service Worker z wersjonowanym systemem pamięci podręcznej (Cache Storage) — `taskalert-v6`.
...
├── service-worker.js          # Mechanizm pamięci podręcznej i pracy offline (cache v6)
